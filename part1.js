...
console.log(person["age"]); console.log(person.hobbies);
...
const user1 = createUser('harshit('harshit', 'vashsith', 'harshit@gmail.com', 9, "my address");
...
const user1 = new CreateUser('harshit('harshit', 'vashsith', 'harshit@gmail.com', 18, "my address");
